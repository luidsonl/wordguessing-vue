...
<template>
    <div class="space-y-4 mb-4">
        <table class="w-full table-fixed border-collapse select-none touch-none" @mouseup="stopSelect" @mouseleave="stopSelect" @touchend="stopSelect" @touchmove="handleTouchMove">
            <tbody>
                <tr v-for="r in rows" :key="r">
                    ...
                    >
                        <div class="aspect-square w-full transition" :class="isSelected(r, c) ? 'bg-blue-500' : 'bg-gray-200'"></div>
                    </td>
                </tr>
            </tbody>
        </table>
